...
namespace FFAMod
{
    ...
    class CardBarHandlerPatch
    {
        ...
        private static void Prefix(CardBarHandler __instance, ref CardBar[] ___cardBars)
        {
            ...
            bar3.GetComponentInChildren<ProceduralImage.color=PlayerSkinBank.GetPlayerSkinColors(2).winText;
            bar3.name = "Bar3";
            ...
            bar4.GetComponentInChildren<ProceduralImage.color=PlayerSkinBank.GetPlayerSkinColors(3).winText;
            bar4.name = "Bar4";
