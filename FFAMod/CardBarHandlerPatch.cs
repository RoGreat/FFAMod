...
namespace FFAMod
{
    ...
    class CardBarHandlerPatch
    {
        ...
        private static void Prefix(CardBarHandler __instance, ref CardBar[] ___cardBars)
        {
            ...
            bar3.GetChild(0).GetChild(0).GetComponent<ProceduralImage>().color=PlayerSkinBank.GetPlayerSkinColors(2).backgroundColor;
            bar3.name = "Bar3";
            ...
            bar4.GetChild(0).GetChild(0).GetComponent<ProceduralImage>().color=PlayerSkinBank.GetPlayerSkinColors(3).backgroundColor;
            bar4.name = "Bar4";
